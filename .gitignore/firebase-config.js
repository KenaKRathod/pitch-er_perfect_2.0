...
import { getFirestore, collection, doc, getDoc, setDoc, onSnapshot, getDocs, updateDoc, runTransaction, addDoc, serverTimestamp, query, where } from "https://www.gstatic.com/firebasejs/10.11.0/firebase-firestore.js";
...
export { 
  ...
  collection, doc, getDoc, setDoc, onSnapshot, getDocs, updateDoc, runTransaction, addDoc, serverTimestamp, query, where
};
